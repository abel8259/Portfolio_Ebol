	...
	<body>
		...
		<div id="side1-PC">
			...
			<div id="box-link-5-PC">
				...
				<div id="box-img-9-PC">
					<img id="img-2-PC" src="../img_geral/EXERCICIO.png"/>		
				</div>
			...
			<div id="box-1">
				<div id="title-img">
					<img id="img-PC" src="../img_geral/tradicional.png"/>
				</div>
				...
				<div id="about-img">
					<img id="img-2-PC" src="../img_geral/tradicional_TEXT.png"/>
				</div>
			...
			<div id="box-2">
				<div id="title-img">
					<img id="img-PC" src="../img_geral/pitagoricos.png"/>
				</div>
				...
				<div id="about-img">
					<img id="img-2-PC" src="../img_geral/PITAGORICOS_TEXT.png"/>
				</div>
