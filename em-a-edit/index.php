...
<!--cópia substituir os img de text tah feito-->  
	...
	<body>
		<div id="side1-PC">
            ...
            <a href="../img_geral/edition/ema/res1.png" download="../img_geral/edition/ema/res1.png">
				<div id="box-1">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/edition/ema/res1.png"/>
					</div>
			...
			<a href="../img_geral/edition/ema/res2.png" download="../img_geral/edition/ema/res2.png">
				<div id="box-2">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/edition/ema/res2.png"/>
					</div>
