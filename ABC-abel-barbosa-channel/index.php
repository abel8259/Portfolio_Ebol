		...
		<div id="side1-PC">
			...
			<div id="box-link-5-PC">
				...
				<div id="box-texto-10-PC">
					<img id="img-2-PC" src="../img_geral/abc.png"/>	
				</div>	
			</div>
	        <a href="../GoP/index.php">
				<div id="box-1">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/GoP.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/GOPTEXT.png"/>
					</div>

				</div>
            </a>
             <a href="../DESTINY-FPS-RPG/index.php">
				<div id="box-2">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/drpg_IMG.png"/>
					</div>
             ...
             <a href="../TRLRS/index.php">
				<div id="box-3">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/TRLRS_IMG.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/TRLRS_TEXT.png"/>
					</div>
            ...
            <a href="#">
				<div id="box-4">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/ncios.png"/>
					</div>
