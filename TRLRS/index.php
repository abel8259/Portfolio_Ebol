	...
	<body>
		<div id="side1-PC">
	        ...
	        <a href="../GOP-S01/index.php">
				<div id="box-1">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/ppYT.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/YT_TEXT.png"/>
					</div>
             ...
             <a href="../GOP-S02/index.php">
				<div id="box-2">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/ppLV.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/LV_TEXT.png"/>
					</div>
