	...
	<body>
		...
		<div id="side1-PC">
			...
			<div id="box-link-5-PC">
				...
				<div id="box-img-9-PC">
					<img id="img-2-PC" src="../img_geral/MOD_U.png"/>		
				</div>

				<div id="box-texto-10-PC">
					<img id="img-2-PC" src="../img_geral/MODULO1_TEXT.png"/>	
				</div>	
			</div>
            <a href= "../curso_advprob_mod1_exerc/index.php">
				<div id="box-1">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/EXERCICIO.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/EXERCICIO_TEXT.png"/>
					</div>

				</div>
		    </a>
            <a href="../curso_advprob_mod1_formula/index.php">    
			<div id="box-2">
				<div id="title-img">
					<img id="img-PC" src="../img_geral/formula.png"/>
				</div>
				...
				<div id="about-img">
					<img id="img-2-PC" src="../img_geral/FORMULA_TEXT.png"/>
				</div>

			</div>
		   </a>
			<a href= "../curso-adv-prob/index.php">
				<div id="box-3">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/teoria.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/TEORIA_TEXT.png"/>
					</div>
