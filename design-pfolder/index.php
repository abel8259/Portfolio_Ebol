		...
		<div id="side1-PC">
			...
			<div id="box-link-5-PC">
				...
				<div id="box-texto-10-PC">
					<img id="img-2-PC" src="../img_geral/design-text.png"/>
				</div>
				
			</div>
			<a href="../ASC-II(PFOLDER)/index.php">
				<div id="box-1">

					<div id="title-img">
						<img id="img-PC" src="../img_geral/ASC-II.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/ASC-II-text.png"/>
					</div>

				</div>
			</a>
			
			<a href="../edition/index.php">			
				<div id="box-2">

					<div id="title-img">
						<img id="img-PC" src="../img_geral/edition.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/edition-text.png"/>
					</div>

				</div>
            </a>
		    <a href="../mont/index.php">	
				<div id="box-3">

					<div id="title-img">
						<img id="img-PC" src="../img_geral/montagem.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/montagem-text.png"/>
					</div>

				</div>
			</a>
		    <a href="../comic/index.php">	
				<div id="box-4">
