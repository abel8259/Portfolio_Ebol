		...
		<div id="side1-PC">
			...
			<a href="../eclipse-med/index.php">
				<div id="box-1">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/eclipse-med.png"/>
					</div>

				</div>
			</a>

			<a href="../glasses-med/index.php">
				<div id="box-2">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/ppe.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/glasses-med.png"/>
					</div>

				</div>
			</a>
			<a href="../green-med/index.php">
				<div id="box-3">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/ppe.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/green-med.png"/>
					</div>

				</div>
			</a>

			<a href="../2buttons/index.php">
				<div id="box-4">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/ppe.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/2BUTTONS.png"/>
					</div>
