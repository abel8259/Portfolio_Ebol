		...
		<div id="side1-PC">
	        <a href="#">
				<div id="box-link-5-PC">
					...
					<div id="box-img-9-PC">
						<img id="img-PC" src="../img_geral/cellz.png"/>	
					</div>

					<div id="box-texto-10-PC">
						<img id="img-2-PC" src="../img_geral/z.png"/>
					</div>	
				</div>
			</a>
	        
			
	        <a href="https://apployd.herokuapp.com/src/Paint_Bruh/index.php">
				<div id="box-1">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/android.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/app.png"/>
					</div>

				</div>
			</a>

            <a href="https://abel8259.github.io/paintBruh-/">
				<div id="box-2">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/www.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/site.png"/>
					</div>
