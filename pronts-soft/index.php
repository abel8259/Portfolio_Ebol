	...
	<body>
		<div id="side1-PC">
			...
			<a href="../ldpg-v/index.php"> 
				<div id="box-1">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/ppmgst.png"/>
					</div>
            ...
            <a href="https://apployd.herokuapp.com/src/home/index.php">
				<div id="box-3">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/loyd.png"/>
					</div>
			...
			<a href="https://portfolioebol.herokuapp.com/">
				<div id="box-4">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/peboll.png"/>
					</div>
        ...
        <a href="https://sigdu-kingdom.herokuapp.com/">
			<div id="box-6">
				...
				<div id="about-img">
					<img id="img-2-PC" src="../img_geral/ogame.png"/>
				</div>
			...
			<a href="https://resig-home.herokuapp.com/">
				<div id="box-7">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/resig--hub.png"/>
					</div>
