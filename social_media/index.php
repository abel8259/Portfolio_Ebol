...
<html>
	...
	<body>
		<div id="side1-PC">
			...
			<a href="https://www.facebook.com/abel.barbosa.23">
				<div id="box-1">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/FB.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/FB-txt.png"/>
					</div>

				</div>
			</a>
			<a href="https://www.instagram.com/abel_barbosa4/?hl=pt-br">
				<div id="box-2">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/IG.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/IG-txt.png"/>
					</div>
