		...
		<div id="side1-PC">
	        ...
	        <a href="../conhecimento/index.php">
				<div id="box-1">
					...
					<div id="icon-img">
						<img id="img-PC" src="../img_geral/cell0.png"/>
					</div>

					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/knowledge.png"/>
					</div>

				</div>
			</a>

			<a href="../autoconhecimento/index.php">
				<div id="box-2">
						...
						<div id="icon-img">
							<img id="img-PC" src="../img_geral/cell1.png"/>
						</div>
			...
			<a href="../eventos/index.php">
				<div id="box-3">
						...
						<div id="icon-img">
							<img id="img-PC" src="../img_geral/cell2.png"/>
						</div>
			...
			<a href="../piadas/index.php">
				<div id="box-4">
						...
						<div id="icon-img">
							<img id="img-PC" src="../img_geral/cell3.png"/>
						</div>
            ...
            <a href="../social_media/index.php">
				<div id="box-5">
						...
						<div id="icon-img">
							<img id="img-PC" src="../img_geral/cell4.png"/>
						</div>

					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/redessociais.png"/>
					</div>
