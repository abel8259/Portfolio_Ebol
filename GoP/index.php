...
<html>
	...
	<body>
		<div id="side1-PC">
	        ...
	        <a href="../GOP-S01/index.php">
				<div id="box-1">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/ppS01.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/S01_TEXT.png"/>
					</div>

				</div>
            </a>
             <a href="../GOP-S02/index.php">
				<div id="box-2">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/ppS02.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/S02_TEXT.png"/>
					</div>

				</div>
            </a>
             <a href="../GOP-OVA/index.php">
				<div id="box-3">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/ppOVA.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/OVA.png"/>
					</div>
