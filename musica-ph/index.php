		...
		<div id="side1-PC">
			...
			<a href="musica/intro.mp3"> 
				<div id="box-1">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/intro.png"/>
					</div>

				</div>
			</a>
			<a href="musica/final.mp3"> 
				<div id="box-2">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/chip.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/final.png"/>
					</div>

				</div>
			</a>
			<a href="musica/charge.mp3"> 
				<div id="box-3">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/charge.png"/>
					</div>
