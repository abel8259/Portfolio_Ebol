	...
	<body>
		...
		<div id="side1-PC">
			...
			<div id="box-link-5-PC">
				...
				<div id="box-img-9-PC">
					<img id="img-2-PC" src="../img_geral/curso-title.png"/>		
				</div>

				<div id="box-texto-10-PC">
					<img id="img-2-PC" src="../img_geral/prob-text.png"/>	
				</div>	
			</div>
            <a href="../modulo_1_cursoadv_prob/index.php"> 
				<div id="box-1">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/MOD_U.png"/>
					</div>
