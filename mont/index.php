		...
		<div id="side1-PC">
			...
			<div id="box-link-5-PC">
					...
					<div id="box-texto-10-PC">
						<img id="img-2-PC" src="../img_geral/mont-text.png"/>
					</div>	
			</div>

			<a href="../afz-mont-RES/index.php">
				<div id="box-1">
			...
			<a href="../em-a-mont-RES/index.php">			
				<div id="box-2">
			...
			<a href="../pronts-mont-RES/index.php">	
				<div id="box-4">
