	...
	<body>
		...
		<div id="side1-PC">
			...
			<div id="box-link-5-PC">
				...
				<div id="box-img-9-PC">
					<img id="img-2-PC" src="../img_geral/formula.png"/>		
				</div>
            ...
            <a href= "https://prnt.sc/xzkomt">
				<div id="box-1">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/code_formula.png"/>
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/CODE_TEXT.png"/>
					</div>

				</div>
            </a>
            <a href= "https://prnt.sc/xzkekp">
			<div id="box-2">
				<div id="title-img">
					<img id="img-PC" src="../img_geral/img_formula.png"/>
				</div>
