		...
		<div id="side1-PC">
			...
			<div id="box-link-5-PC">
				...
				<div id="box-texto-10-PC">
					<img id="img-2-PC" src="../img_geral/DESIGN-sprint.png"/>
				</div>
			</div>

             <a href="https://abel8260.github.io/callcompass/proto1/page2.htm"> 
				<div id="box-1">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/CALL-compass.png"/>
					</div>

				</div>
            </a>
            
			<a href="https://abel8259.github.io/pcraftbrasil/Untitled-1.htm"> 
				<div id="box-2">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/craft-br.png"/>
					</div>
