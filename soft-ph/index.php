		...
		<div id="side1-PC">
			...
			<div id="box-link-5-PC">
				...
				<div id="box-texto-10-PC">
					<img id="img-2-PC" src="../img_geral/soft.png"/>
				</div>
				
			</div>
			<a href="https://audacity.br.uptodown.com/windows">
				<div id="box-1">
					...
					<div id="icon-img">
						<img id="img-PC" src="../img_geral/novwchip.png"/>
					</div>

					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/audacity.png"/>
					</div>

				</div>
			</a>
			
			<a href="https://formatfactory.br.uptodown.com/windows">			
				<div id="box-2">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/format.png"/>
					</div>
			...
			<a href="https://www.microsoft.com/pt-br/software-download/windows10">
				<div id="box-3">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/wmm.png"/>
					</div>
				</div>
			</a>
			<a href="https://www.openshot.org/pt/">
				<div id="box-4">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/ove.png"/>
					</div>
				</div>
			</a>
