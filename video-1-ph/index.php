	...
	<body>
		<div id="side1-PC">
			...
			<div id="box-link-5-PC">
				...
				<div id="box-img-9-PC">
					<img id="img-PC" src="../img_geral/vwchip.png"/>
				</div>

				<div id="box-texto-10-PC">
					<img id="img-2-PC" src="../img_geral/1o-video.png"/>
				</div>
				
			</div>
			<a href="../ph-img/index.php">
				<div id="box-1">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/imgtext.png"/>
					</div>

				</div>
			</a>
			
			<a href="../musica-ph/index.php">			
				<div id="box-2">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/musica.png"/>
					</div>

				</div>
            </a>
			<a href="../soft-ph/index.php">
				<div id="box-3">
			...
			<a href="../videos-p1-ph/index.php">
				<div id="box-4">
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/videos.png"/>
					</div>
